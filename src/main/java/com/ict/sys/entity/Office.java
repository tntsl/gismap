...
public class Office extends DataEntity {
	...
	@Id
	@TableGenerator(name = "sys_office_generator", table = "web_tab_pk", pkColumnName = "G_KEY", pkColumnValue = "sys_office", valueColumnName = "G_VALUE", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "sys_office_generator")
	public Long getId() {
		return id;
	}
